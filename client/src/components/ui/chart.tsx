...
type ChartPayload = TooltipPayloadEntry<TooltipValueType, TooltipNameType> | LegendPayload
...
function getPayloadConfigFromPayload(
  ...
  const configLabelKey = typeof payload.dataKey === "string" ? payload.dataKey : key
