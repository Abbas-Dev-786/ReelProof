...
export function CampaignPreview({ campaign }: CampaignPreviewProps) {
  if (campaign.reel_url) {
    return (
      <div className="relative aspect-[9/16] overflow-hidden bg-[#20202b]">
  ...
  return (
    <div className="relative aspect-[9/16] overflow-hidden bg-[linear-gradient(160deg,#373153_0%,#6b5ab1_44%,#e69d58_100%)] p-5 text-white">
